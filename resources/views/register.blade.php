...
<body class="bg-gray-100 min-h-screen flex items-center justify-center font-prompt">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <button type="submit"
                class="w-full bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors">สมัครสมาชิก
            </button>

            <div class="mt-4 text-center">
                <a href="{{ route('login') }}" class="text-blue-600 hover:text-blue-800 text-sm">มีบัณชีแล้ว? เข้าสู่ระบบที่นี่</a>
            </div>
        </form>
    </div>
